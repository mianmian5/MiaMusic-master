...
import com.example.miamusic_master.util.TimeUtil;
 ...
 * 评论界面的Adapter
 */
public class PlaylistCommentAdapter extends BaseAdapter<RecyclerView.ViewHolder, PlayListCommentBean.CommentsBean> {
    private static final String TAG = "CommentAdapter";

//    private List<MusicCommentBean.CommentsBean> list = new ArrayList<>();
    private List<PlayListCommentBean.CommentsBean> list = new ArrayList<>();
    private Context mContext;
    private OnLikeCommentListener listener;

    public PlaylistCommentAdapter(Context context) {
        super(context);
        mContext = context;
    }
...
//        List<MusicCommentBean.CommentsBean> list = new ArrayList<>();
//        list.addAll(dataList);
//        notifyDataSetChanged();
//    }
    @Override
    public void notifyDataSetChanged(List<PlayListCommentBean.CommentsBean> dataList) {
        list=dataList;
        notifyDataSetChanged();
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        if (viewHolder != null) {
            ...
            PlayListCommentBean.CommentsBean bean = list.get(i);
            vh.setBean(bean, i);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setBean(PlayListCommentBean.CommentsBean bean, int position) {
            ...
            int likeCount = bean.getLikedCount();
//            boolean moreThanWan = false;
            if (likeCount > 10000) {
                likeCount = likeCount / 10000;
//                moreThanWan = true;
            }
            String res;
//            if (moreThanWan) {
